...
path = os.path.join(os.path.dirname(os.path.abspath(__file__)), pbots_calc)
pcalc = ctypes.cdll.LoadLibrary(path)
...
if __name__ == "__main__":
    # NOTE: need the bytes thing for python3.
    res = calc(b"AcAd:xx", b"2c3c4c", b"", 10000)
    print(res.ev[0])
